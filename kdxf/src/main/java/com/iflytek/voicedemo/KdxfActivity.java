...
public class KdxfActivity extends Activity implements OnClickListener {
	...
	public void onClick(View view) {
		...
		case 0:
			// 语音转写
			intent = new Intent(KdxfActivity.this, IatDemo.class);
			break;
		case 1:
			// 语法识别
			intent = new Intent(KdxfActivity.this, AsrDemo.class);
			break;
		case 2:
			// 语义理解
		...
		case 3:
			// 语音合成
			intent = new Intent(KdxfActivity.this, TtsDemo.class);
			break;
		case 4:
			// 语音评测
			intent = new Intent(KdxfActivity.this, IseDemo.class);
			break;
		case 5:
			// 唤醒
		...
		case 6:
			// 声纹
			intent = new Intent(KdxfActivity.this, VocalVerifyDemo.class);
			break;
		case 7:
			intent = new Intent(KdxfActivity.this,OnlineFaceDemo.class);
			break;
		/*case 8:
			Intent init = new Intent(KdxfActivity.this, UrlSettings.class);
	...
	private class SimpleAdapter extends BaseAdapter {
		public View getView(int position, View convertView, ViewGroup parent) {
			if (null == convertView) {
				LayoutInflater factory = LayoutInflater.from(KdxfActivity.this);
				View mView = factory.inflate(R.layout.list_items, null);
				convertView = mView;
			}
			
			Button btn = (Button) convertView.findViewById(R.id.btn);
			btn.setOnClickListener(KdxfActivity.this);
			btn.setTag(position);
	...
	protected void onResume() {
		// 开放统计 移动数据统计分析
		FlowerCollector.onResume(KdxfActivity.this);
	...
	protected void onPause() {
		...
		FlowerCollector.onPause(KdxfActivity.this);
		super.onPause();
	}
